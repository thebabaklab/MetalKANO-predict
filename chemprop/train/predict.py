...
def predict(
    model: nn.Module, prompt: bool, data: MoleculeDataset, batch_size: int, scaler: StandardScaler = None
) -> List[List[float]]:
    """
    ...
    for i in tqdm(range(0, num_iters, iter_step), total=(num_iters//batch_size)):
        # Prepare batch
