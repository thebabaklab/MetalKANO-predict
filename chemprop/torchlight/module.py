...
class LSTM4VarLenSeq(nn.Module):
    def __init__(
        self, input_size, hidden_size, num_layers=1, bias=True, bidirectional=False, init="orthogonal", take_last=True
    ):
        """
        no dropout support
...
if __name__ == "__main__":
    ...
    # ================
    net = LSTM4VarLenSeq(200, 100, num_layers=3, bias=True, bidirectional=True, init="orthogonal", take_last=False)

    inputs = torch.tensor([[1, 2, 3, 0], [2, 3, 0, 0], [2, 4, 3, 0], [1, 4, 3, 0], [1, 2, 3, 4]])
